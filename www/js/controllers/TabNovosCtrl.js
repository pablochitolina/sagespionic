app.controller('TabNovosCtrl', function (myConfig, $scope, ionicMaterialInk, ionicMaterialMotion, $window, $http) {
    ...
    var _base64 = {
        ...
        $http.defaults.headers.common["iduser"] = iduser;
        $http.defaults.headers.common["status"] = "novo";
